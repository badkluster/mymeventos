...
export type Customer = { _id: string; fullName?: string; firstName?: string; lastName?: string; phone?: string; email?: string; documentNumber?: string; address?: string; occupation?: string; birthDate?: string; sourceLeadId?: string | LeadOption; quoteCount?: number; eventCount?: number; lastEvent?: { eventDate?: string; eventName?: string }; createdAt?: string; notes?: string };
