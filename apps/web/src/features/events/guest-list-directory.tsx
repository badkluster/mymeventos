...
export function UnassignedGuestsPanel({ guests, tables, selectedGuestIds, onToggleSelected, onEditGuest, onAssign, onBulkAssign }: UnassignedGuestsPanelProps) {
