...
export function EventGuestListEditor({ event, plan, saving, onSaveGuestList, onServerGuestList, onSyncSummary, onNotice }: { event: Event; plan?: EventResourcePlan; saving: boolean; onSaveGuestList: (guestList: EventGuestList) => Promise<EventGuestList | undefined>; onServerGuestList: (guestList: EventGuestList) => void; onSyncSummary: (payload: Record<string, unknown>) => void; onNotice?: (message: string, variant?: 'success' | 'error') => void }) {
  return <GuestListWorkspace event={event} plan={plan} saving={saving} onSaveGuestList={onSaveGuestList} onServerGuestList={onServerGuestList} onSyncSummary={onSyncSummary} onNotice={onNotice} />;
}
