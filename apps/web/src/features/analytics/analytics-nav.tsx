...
export function AnalyticsNav() {
  ...
  const items = [
    ...
    { href: '/admin/analytics/heatmap', label: 'Interacciones', permission: Permission.ANALYTICS_HEATMAP_VIEW },
    { href: '/admin/analytics/settings', label: 'Privacidad', permission: Permission.ANALYTICS_SETTINGS_MANAGE },
