...
export default function EventDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <section className="space-y-6 pb-8">
    ...
    {activeTab === 'cronograma' && <EventOperationsWorkspace key={event._id} event={event} plan={resourcePlan} saving={editingDisabled} onSave={saveResourcePlan} onSyncSummary={(payload) => void patchEvent(payload)} onNotice={notice} />}
