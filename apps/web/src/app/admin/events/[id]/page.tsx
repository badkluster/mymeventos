...
import { EventBasicsEditor, EventCommercialEditor, EventLogisticsEditor, EventResourcesEditor, EventSuppliersEditor, EventTasksEditor, EventTimelineEditor, eventOperationalSummary, normalizeResourcePlan } from '@/features/events/event-operations';
