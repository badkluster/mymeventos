...
type DetailResponse = { customer: Customer; quotes: Quote[]; events: Event[]; quoteRequests: QuoteRequest[]; contracts?: Contract[]; payments?: Payment[]; paymentSummary?: PaymentSummary; activities: Activity[]; changeHistory?: EntityChangeHistory };
...
export default function CustomerDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <section className="space-y-6 pb-8">
    ...
    <EntityChangeHistoryCard history={data.changeHistory} subjectLabel="cliente" />
