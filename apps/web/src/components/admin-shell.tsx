...
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  const configSubmenuPaths = new Set(['/admin/salons', '/admin/users', '/admin/staff', '/admin/attendance', '/admin/landing', '/admin/imports']);
  const configSubmenuOrder = new Map([['/admin/salons', 0], ['/admin/users', 1], ['/admin/staff', 2], ['/admin/attendance', 3], ['/admin/landing', 4], ['/admin/imports', 5]]);
