    ...
    <section ref={heroRef as React.RefObject<HTMLElement>} id="inicio" data-analytics-section="hero" className="relative min-h-[100svh] overflow-hidden">
      ...
      <div className="relative mx-auto grid min-h-[100svh] max-w-[1600px] items-center px-5 pb-36 pt-28 sm:px-8 md:pb-32 md:pt-36 lg:px-12 xl:px-16">
        <motion.div initial={shouldReduceMotion ? false : 'hidden'} animate={shouldReduceMotion ? undefined : 'visible'} variants={listVariants} className="min-w-0 max-w-[780px]">
          ...
          <motion.p variants={cardVariants} style={displayFont} className="mt-7 max-w-[690px] text-pretty text-[17px] leading-7 text-white/82 sm:text-[20px] sm:leading-8">{settings.heroSubtitle || 'Salones para cumpleaños, fiestas de 15 y casamientos, con catering, DJ, ambientación y organización integral.'}</motion.p>
