...
export const roleLabels: Record<string,string>={ADMIN:'Administrador',MANAGER:'Manager',SALON_MANAGER:'Encargado salón',SALES:'Comercial',OPERATIONS:'Operaciones',ACCOUNTING:'Administración/Cobros',STAFF:'Staff',VALIDATOR:'Validador'};
