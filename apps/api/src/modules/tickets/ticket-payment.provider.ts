...
export type CreateTicketCheckoutInput = { orderId: string; orderCode: string; title: string; amount: number; currency: string; buyer: { name: string; email: string }; notificationUrl?: string };
...
export type TicketProviderPayment = { providerPaymentId: string; status: TicketProviderPaymentStatus; statusDetail?: string; amount?: number; raw?: unknown };
