...
const orderSchema = new Schema(
  {
    ...
    documentStatus: { type: String, enum: ["pending", "generating", "generated", "failed"], default: "pending" },
    ticketsPdf: { storageKey: String, url: String, filename: String, mimeType: String, sizeBytes: Number, layout: String, ticketCount: Number, version: Number, generatedAt: Date, checksum: String },
    ...audit,
  },
  { timestamps: true },
);
...
const ticketSchema = new Schema(
  {
    ...
    accessPoint: String,
    pdf: { storageKey: String, url: String, filename: String, mimeType: String, sizeBytes: Number, layout: String, version: Number, generatedAt: Date, checksum: String },
    ...audit,
  },
  { timestamps: true },
);
