...
const baseLegalTerms = [
  ...
  { key: 'image_rights', title: 'Autorización de registro y uso de imagen y contenido audiovisual', text: 'EL CLIENTE autoriza expresamente a M&M Eventos a registrar, mediante fotografías, video y audio, el evento contratado, incluyendo imágenes, voz, ambientación, producciones y demás contenidos generados durante su realización. Asimismo, autoriza a M&M Eventos a reproducir, editar, adaptar, publicar, comunicar y difundir dicho material, sin límite territorial y sin contraprestación económica adicional, en su sitio web, redes sociales, portfolio, presentaciones comerciales, piezas audiovisuales, campañas orgánicas y publicitarias, incluyendo reels y anuncios pagos, con la finalidad de comunicar, promocionar y publicitar sus servicios. Esta autorización se otorga por el plazo legalmente permitido. M&M Eventos se compromete a no utilizar el material de modo lesivo, engañoso, denigrante ni que afecte la dignidad, intimidad, honra o reputación de las personas retratadas. EL CLIENTE declara que informará de forma previa y clara a las personas asistentes, proveedores, artistas y personal involucrado sobre la posible realización y posterior uso promocional del material. Respecto de personas identificables que participen como protagonistas o aparezcan de forma destacada, EL CLIENTE se obliga a gestionar las autorizaciones correspondientes; si se trata de menores de edad, deberá obtener la autorización de su madre, padre o representante legal. Las personas que deseen solicitar la no utilización futura de una imagen identificable podrán comunicarse a info.mymsalones@gmail.com. M&M Eventos atenderá dichas solicitudes conforme a la normativa aplicable y, cuando corresponda, adoptará medidas razonables respecto del material cuya publicación continúe bajo su control.' },
